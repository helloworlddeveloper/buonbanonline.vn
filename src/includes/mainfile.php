...
define('NV_NOTIFICATION_SHOP', $db_config['prefix'] . '_notification_shop');
define('NV_NOTIFICATION_USER', $db_config['prefix'] . '_notification_user');
...
define('NV_REFSTAT_TABLE', NV_PREFIXLANG . '_referer_stats');
    ...
    // Define some Key
    //$redis->set('user', 'trung nghĩa redis ok');
